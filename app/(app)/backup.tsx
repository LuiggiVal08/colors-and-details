    ...
    <ScreenLayout>
      <View className="w-full max-w-3xl px-4 py-6">
        <View className="items-center rounded-[32px] bg-white p-8 dark:bg-primary-dark">
          ...
          <Text className="mb-2 text-2xl font-bold text-slate-900 dark:text-white">Respaldo</Text>
          <Text className="text-center text-base leading-6 text-slate-500 dark:text-slate-400">
