    ...
    <ScreenLayout>
      <ScrollView className="w-full px-4 py-6">
        <View className="mb-6 min-w-[280px] flex-1 rounded-[32px]  bg-white bg-gradient-to-r from-pink-100 via-white to-slate-50 p-6 dark:bg-primary-dark ">
          <Text className="mb-2 text-3xl font-bold text-slate-900">Centro de soporte</Text>
          <Text className="max-w-3xl text-base leading-7 text-slate-600">
              ...
              <View key={developer.name} className="rounded-[32px] bg-white p-6 shadow-lg shadow-slate-200/80 dark:bg-primary-dark">
                <View className="flex-row items-center gap-4">
                  ...
                  <View className="flex-1">
                    <Text className="mb-1 text-xl font-semibold text-slate-900">{developer.name}</Text>
                    <View className="flex-row items-center gap-2">
                      <Ionicons name="call-outline" size={16} color="#64748b" />
                      <Text className="text-sm text-slate-500">{developer.phone}</Text>
                    </View>
                  </View>
                </View>
              </View>
