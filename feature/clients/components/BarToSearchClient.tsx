...
import type { SearchBarProps } from '@/feature/clients/types';

const BarToSearchClient = ({ value, onChangeText, placeholder = 'Buscar clientes...' }: SearchBarProps) => {
  return (
...
export default BarToSearchClient;
